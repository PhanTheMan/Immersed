...
const KArcadeMenu = lazy(() =>
  import("../components/zones/training/languages/korean/KArcadeMenu")
);
const KArcadeMain = lazy(() =>
  import("../components/zones/training/languages/korean/KArcadeMain")
);
const KArcadeAudioInForm = lazy(() =>
  import("../components/zones/training/languages/korean/KArcadeAudioInForm")
);
...
const ZoneEntry = lazy(() => import("../components/zones/splash/ZoneSplash"));
...
const ZoneLogin = lazy(() => import("../components/zones/login/ZoneLogin"));
const ZoneMain = lazy(() => import("../components/zones/mains/ZoneMain"));
const ZoneMenu = lazy(() => import("../components/zones/menus/ZoneMenu"));
